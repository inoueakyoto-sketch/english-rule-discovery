...
## v1.0.9 visual source
`design/VISUAL_SOURCE_OF_TRUTH.png` is the approved ivory / navy / gold mockup. `design/VISUAL_SOURCE_OF_TRUTH_v1.0.8.png` is retained only for historical comparison.


## v1.0.10 visual source
- `design/VISUAL_SOURCE_OF_TRUTH.png` — approved layout + palette source.
- `qa/SOURCE_VS_V110_FINAL.png` — source-to-production comparison.
- `qa/VISUAL_QA_CONTACT_SHEET_v1.0.10_FINAL.png` — production render board.
No new decorative asset dependency was introduced; v1.0.10 primarily changes composition and surface treatment.
